...
class RecepcionistaController extends GxController {
    ...
    public function actionView($id) {
        $model = $this->loadModel($id, 'Recepcionista');
    ...
    public function actionCreate() {
        ...
        $this->performAjaxValidation(array($model_pessoa, $model_usuario, $model_endereco), 'recepcionista-form');
        ...
        if (isset($_POST['UserGroupsUser']) && $_POST['UserGroupsUser']['username'] && $_POST['UserGroupsUser']['password']) {
            ...
            $model_usuario->group_id = 5; //recepcionista
        ...
        //salva recepcionista e redireciona
        if ($model->save()) {
    ...
    public function actionUpdate($id) {
        ...
        $this->performAjaxValidation(array($model_pessoa, $model_endereco), 'recepcionista-form');
    ...
    public function actionDelete($id) {
        if (Yii::app()->getRequest()->getIsPostRequest()) {
            $model_recepcionista = $this->loadModel($id, 'Recepcionista');
            $model_pessoa = $this->loadModel($model_recepcionista->id_pessoa, 'Pessoa');
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['Recepcionista']))
            $model->setAttributes($_GET['Recepcionista']);
