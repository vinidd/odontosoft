...
<h1>
    ...
    <span style="float: right;">
        <a style="text-decoration: none;" href="<?php echo Yii::app()->createUrl('recepcionista/update', array('id' => $model->id_recepcionista)); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo Yii::t('app', 'Edit'); ?>">
            <i class="icon-pencil"></i>
        </a>
        <?php if (Yii::app()->user->pbac('Basic.recepcionista.admin')) { ?>
            &nbsp;
            <a style="text-decoration: none;" href="<?php echo Yii::app()->createUrl('recepcionista/admin'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo Yii::t('app', 'Manage'); ?>">
