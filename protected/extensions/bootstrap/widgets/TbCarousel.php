...
class TbCarousel extends CWidget {
    ...
    public function run() {
        ...
        if ($this->displayIndicators && !empty($this->items)) {
    ...
    protected function renderItems($items) {
        foreach ($items as $i => $item) {
            ...
            if (isset($item['image'])) {
                ...
                echo '<a href="' . Yii::app()->request->baseUrl . '/' . $item['url'] . '">' . CHtml::image($item['image'], $item['alt'], $item['imageOptions']) . '</a>';
            }
